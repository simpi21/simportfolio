                    ...
                    <div class="sim-header">
                            ...
                            <side-navigation :active="active" @close="active = false" nav-width="300px">
                                <ul class="menu">
                                    <li class="menu__item nav-item">
                                        <a href="#/" @click="activeNav = false">Home</a>
                                    </li>
                                    <li class="menu__item nav-item">
                                        <a href="#/about-me" @click="activeNav = false">AboutUs</a>
                                    </li>
                                    <li class="menu__item nav-item">
                                        <a href="#/work" @click="activeNav = false">MyWork</a>
                                    </li>
                                    <li class="menu__item nav-item">
                                        <a href="#/skill" @click="activeNav = false">Skill</a>
                                    </li>
                                    <li class="menu__item nav-item">
                                        <a href="#/blog" @click="activeNav = false">MyBlog</a>
                                    </li>
                                    <li class="menu__item nav-item">
                                        <a href="#/contact-me" @click="activeNav = false">ContactUs</a>
                                    </li>
                                </ul>
                            </side-navigation>
                        </div>
                        ...
                        <span>
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" role="img"
                                 ...
                                 class="svg-inline--fa fa-github fa-w-16"><path
                            ...
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin-in"
                                 ...
                                 class="svg-inline--fa fa-linkedin-in fa-w-14"><path
                            ...
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" role="img"
                                 ...
                                 class="svg-inline--fa fa-twitter fa-w-16"><path
...
<style lang="scss">
    ...
    .sim-bg {
        ...
        .box .blob b:first-child {
            ...
            animation: radious 30s ease-in-out infinite both alternate,
